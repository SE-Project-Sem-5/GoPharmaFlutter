...
class OrderListState {
  ...
  static OrderListState get initialState => OrderListState(
        ...
        normalOrderList: {
          ...
          "unpaid": new NormalOrderList(orders: []),
          "toBeReturned": new NormalOrderList(orders: []),
          "reservedForReturn": new NormalOrderList(orders: []),
          "collectedForReturn": new NormalOrderList(orders: []),
